...
const perks = [
  {
    ...
    description: "Get your assets delivered to your e-mail in seconds and download them right away."
  },
  {
  ...
  },
  {
    name: "For the planet",
    icon: Leaf,
    description: "We've pledged 1% of sales to the preservation and restoration of our natural environment."
  },
];
